...
pub const ACCESS_KEY_NAME_PREFIX: &str = "cep78_contract_package_access";
pub const CONTRACT_NAME_PREFIX: &str = "cep78_contract_hash";
pub const CONTRACT_VERSION_PREFIX: &str = "cep78_contract_version";
...
pub const CEP78_PREFIX: &str = "cep78";
